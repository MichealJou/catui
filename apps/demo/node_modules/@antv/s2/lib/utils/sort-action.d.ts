import type { SortMethod, SortParam } from '../common/interface';
 ...
 */
export declare const sortAction: (list: (number | string)[] | CellData[], sortMethod?: SortMethod, key?: string) => (string | number)[] | CellData[];
