 ...
 */
export const sortAction = (list, sortMethod, key) => {
...
const sortByMethod = (params) => {
    ...
    let result;
    if (sortByMeasure) {
        const dimensions = sortAction(measureValues, sortMethod, sortByMeasure === TOTAL_VALUE ? query === null || query === void 0 ? void 0 : query[EXTRA_FIELD] : sortByMeasure);
        const fields = (isInRows ? rows : getLeafColumnsWithKey(columns));
        result = getDimensionsWithParentPath(sortFieldId, fields, dimensions);
    }
    else {
        result = sortAction(measureValues, sortMethod);
    }
