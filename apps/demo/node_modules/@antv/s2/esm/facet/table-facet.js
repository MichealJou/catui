...
export class TableFacet extends FrozenFacet {
    ...
    getCompactColNodeWidth(colNode) {
        ...
        // 采样前 50，找出表身最长的数据
        const maxLabel = maxBy(data === null || data === void 0 ? void 0 : data.slice(0, LAYOUT_SAMPLE_COUNT).map((data) => { var _a; return `${(_a = formatter === null || formatter === void 0 ? void 0 : formatter(data[colNode.field])) !== null && _a !== void 0 ? _a : data[colNode.field]}`; }), (label) => this.measureTextWidth(label, dataCellTextStyle));
