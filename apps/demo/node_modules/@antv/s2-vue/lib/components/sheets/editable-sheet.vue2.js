...
require("./editable-sheet/drag-copy/DragCopyMask.vue.js");
const DragCopyPoint = require("./editable-sheet/drag-copy/DragCopyPoint.vue.js");
...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    const { options: originOptions } = vue.toRefs(props);
    const inputRef = vue.ref(null);
    const targetCell = vue.ref(null);
    ...
    function setInputStyle() {
      ...
      let cellPosition = lodash.pick(cell.getMeta(), ["x", "y", "width", "height"]);
      if (lodash.isNil(cellPosition.x) || lodash.isNil(cellPosition.y)) {
        cellPosition = {
          x: 0,
          y: 0,
          width: 0,
    ...
    vue.watch([targetCell, (_a = s2Ref.value) == null ? void 0 : _a.instance.facet.getScrollOffset()], () => {
      setInputStyle();
    });
