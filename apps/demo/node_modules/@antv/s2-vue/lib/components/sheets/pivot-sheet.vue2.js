...
const index = require("../drill-down/index.vue.js");
...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    const onDrillDownIconClick = (params) => {
      ...
      if (event) {
        const instance = (_a = s2Ref == null ? void 0 : s2Ref.value) == null ? void 0 : _a.instance;
        const drillDownNode = vue.createVNode(index, __spreadProps(__spreadValues({}, (_b = partDrillDown.value) == null ? void 0 : _b["drillConfig"]), {
          setDrillFields,
