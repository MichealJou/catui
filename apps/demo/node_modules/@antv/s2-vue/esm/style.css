...
.antv-s2-drill-down-header[data-v-51804a8c] {
  display: flex;
  height: 32px;
  font-size: 14px;
  padding: 0 16px;
...
.antv-s2-drill-down-header button[data-v-51804a8c] {
  position: absolute;
  right: 0;
  top: 0;
  font-size: 12px;
...
.antv-s2-drill-down-search[data-v-51804a8c] {
  height: 24px;
...
.antv-s2-drill-down-search input[data-v-51804a8c],
.antv-s2-drill-down-search span[data-v-51804a8c] {
  font-size: 12px;
}
.antv-s2-drill-down-search[data-v-51804a8c],
.antv-s2-drill-down-search .ant-input[data-v-51804a8c]::placeholder {
  background-color: var(--antv-s2-block-background, #fff);
}
.antv-s2-drill-down-menu[data-v-51804a8c] {
  max-height: 314px;
  overflow: hidden auto;
}
.antv-s2-drill-down-menu.ant-menu[data-v-51804a8c] {
  background: var(--antv-s2-tooltip-background, #fff);
}
.antv-s2-drill-down-menu.ant-menu:not(.ant-menu-horizontal) .ant-menu-item-selected[data-v-51804a8c] {
  background-color: var(--antv-s2-block-background, #e6f7ff);
}
.antv-s2-drill-down-menu-item[data-v-51804a8c] {
  height: 32px !important;
  line-height: 32px !important;
  font-size: 12px;
  opacity: 0.65;
}
.antv-s2-drill-down-menu-item span[data-v-51804a8c]:last-child {
  line-height: 32px;
}
.antv-s2-drill-down-menu-item svg[data-v-51804a8c] {
  margin-right: 8px;
}
.antv-s2-drill-down-empty[data-v-51804a8c] {
  padding: 12px;
  font-size: 12px;
}
